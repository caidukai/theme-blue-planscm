      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
        ...
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">收款</span>
          </span>{" "}
          {/* */}最好的搭档.
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          作为您的记录商户，我们负责处理合规负担，以便您可以专注于增加收入并减少麻烦。
        </p>
              ...
              >
                <li className="flex">
                  <img
                    ...
                    src="/assets/images/transistor.7274e6c3.svg"
                  />
                </li>
                <li className="flex">
                  <img
                    ...
                    data-nimg={1}
                    style={{ color: "transparent" }}
                    src="/assets/images/tuple.74eb0ae0.svg"
                  />
                </li>
                <li className="flex">
                  <img
                    ...
                    data-nimg={1}
                    style={{ color: "transparent" }}
                    src="/assets/images/statickit.d7937794.svg"
                  />
                </li>
              </ul>
            </li>
              ...
              >
                <li className="flex">
                  <img
                    ...
                    data-nimg={1}
                    style={{ color: "transparent" }}
                    src="/assets/images/mirage.18d2ec4e.svg"
                  />
                </li>
                <li className="flex">
                  <img
                    ...
                    data-nimg={1}
                    style={{ color: "transparent" }}
                    src="/assets/images/laravel.7deed17e.svg"
                  />
                </li>
                <li className="flex">
                  <img
                    ...
                    data-nimg={1}
                    style={{ color: "transparent" }}
                    src="/assets/images/statamic.6da5ebfb.svg"
                  />
                </li>
              </ul>
            </li>
