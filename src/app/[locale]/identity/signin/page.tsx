...
const PageSignin = () =>{
  ...
  return (
    ...
    <div className="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">登录 Pilotle</h2>
    </div>
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p className="mt-2 mb-8 text-center text-sm text-gray-500 flex justify-between">
        <a href="#" className="text-xs text-gray-400 hover:text-blue-600 mx-2">忘记密码?</a>
        <a href="/identity/signup" className="text-xs  text-gray-400 hover:text-blue-600  mx-2">立即注册</a>
      </p>
